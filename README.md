...
- Resegmentation tool: `/tools/resegmentation` now uses the live backend list browse/detail RPCs plus the new `entity/resegmentOrganization` dry-run/apply action, while `/design/tools-resegmentation` remains the fixture-backed mock for design review
